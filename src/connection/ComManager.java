...
public class ComManager implements Runnable {
    ...
    public ComManager(
            ...
            TextField portField,
            CheckBox acceptEvolutions,
            CheckBox acceptBenchmarks,
            Button connectButton,
            ProgressBar serverStatusBar,
            TextField serverStatusText) {
        ...
        portField.setOnAction(
                (event) -> {
                    String in;
                    if (portField.getText().length() == 0) in = portField.getPromptText();
                    else in = portField.getText();
                    try {
