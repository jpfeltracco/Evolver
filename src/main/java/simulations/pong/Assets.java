...
public class Assets {
	...
	public static void load(){
		textureatlas = loadTexture("pong_assets/screen_atlas.png");
		...
		font = new BitmapFont(Gdx.files.internal("pong_assets/font.fnt"), Gdx.files.internal("pong_assets/font.png"), false);
		
		bounceSound = Gdx.audio.newSound(Gdx.files.internal("pong_assets/ball_bump.wav"));
	}
